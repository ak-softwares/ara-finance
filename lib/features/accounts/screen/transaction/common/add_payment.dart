...
class AddPayment extends StatelessWidget {
  const AddPayment({super.key, this.transaction});

  final TransactionModel? transaction; // Updated model

  @override
  Widget build(BuildContext context) {
    final AddPaymentController controller = Get.put(AddPaymentController()); // Updated controller
    ...
    return Scaffold(
      appBar: AppAppBar(title: transaction != null ? 'Update Payment' : 'Add Payment'), // Updated title
      bottomNavigationBar: Padding(
        padding: const EdgeInsets.symmetric(horizontal: AppSizes.md, vertical: AppSizes.sm),
        child: ElevatedButton(
          onPressed: () => transaction != null
              ? controller.saveUpdatedPaymentTransaction(oldPaymentTransaction: transaction!) // Updated method
              : controller.savePaymentTransaction(), // Updated method
          child: Text(
            transaction != null ? 'Update Payment' : 'Add Payment',
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Form(
            key: controller.paymentFormKey, // Updated form key
            child: Column(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Obx(() => controller.selectedVendor.value.id != '' && controller.selectedVendor.value.id != null
                        ? Dismissible(
